...
@given('I have a valid email "{email}" and username "{username}"')
...
@given('a secure password "{password}"')
...
@then("I should receive a successful response with status {status_code:d}")
...
@then("my new user account should be created in the system")
...
@given('a user already exists with email "{email}" and username "{username}"')
...
@when('I submit the registration form with email "{email}" and username "{username}"')
...
@then("I should receive an error response with status {status_code:d}")
...
@given('a user already exists with email "{email}" and password "{password}"')
...
@then("the response should contain access and refresh JWT tokens")
